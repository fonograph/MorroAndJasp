...
define(function(){
    ...
    return {
        ...
        audienceLines: {
            ...
            negative: [
                {text: 'I hired a babysitter for THIS?', sound:'i-hired-a-babysitter.mp3'},
                {text: "What's the point of this?", sound:'what-is-the-point.mp3'},
                {text: 'Is this supposed to make sense?', sound:'is-this-supposed.aiff'},
                {text: 'This stinks!', sound:'this-stinks.mp3'},
                {text: 'This sucks!', sound:'this-sucks.mp3'},
                {text: 'Booooooo!', sound:'boo.mp3'},
                ...
                {text: "Let's get out of here!", sound:'lets-get-outta.mp3'},
                {text: 'Not funny!', sound:'not-funny.mp3'},
                {text: 'This is why people hate clowns!', sound:'this-is-why.mp3'},
                {text: 'Where is this going?', sound:'where-is-this-going.mp3'},
                {text: 'Where is this going?', sound:'where-is-this-going2.mp3'},
                {text: 'Why? Why?!', sound:'why-why.mp3'},
                {text: 'Why would you make that choice?!', sound:'why-would-you.mp3'},
                {text: 'Worst. Play. Ever.', sound:'worst-play-ever.mp3'},
                {text: 'You ruined my birthday!', sound:'you-ruined.mp3'},
                {text: '<Grumbling>', sound:'grumbling.mp3'},
                {text: '<Grumbling>', sound:'grumbling2.mp3'},
                {text: '<A single cough>', sound:'cough.mp3'}
            ],
            positive: [
                {text: 'Bravo!', sound:'bravo4.mp3'},
                {text: 'Bravo!', sound:'bravo5.mp3'},
                {text: 'Brava!', sound:'brava.mp3'},
                {text: 'Brilliant!', sound:'brilliant.mp3'},
                {text: 'Tour de force!', sound:'tour-de-force.mp3'},
                {text: 'Amazing!', sound:'amazing.mp3'},
                {text: 'Incredible!', sound:'incredible.mp3'},
                {text: 'Hooray!', sound:'hooray2.mp3'},
                {text: "I've always said I liked clowns!", sound:'ive-always-said.mp3'},
                {text: 'Jasp for mayor!', sound:'jasp-for-mayor.mp3'},
                {text: 'Give them the Tony!', sound:'give-them-the-tony.mp3'},
                {text: "Marry me!", sound:'marry-me.mp3'},
                {text: 'This is amazing!', sound:'this-is-amazing.mp3'},
                {text: 'This is the best!', sound:'this-is-the-best.mp3'},
                {text: "The future of clowning is here!", sound:'the-future.mp3'},
                {text: 'This show is so good!', sound:'this-show-is.mp3'},
                {text: 'What a show!', sound:'what-a-show.mp3'},
                {text: 'Woooo Morro!', sound:'woo-morro.mp3'},
                {text: 'Yes! Yes!', sound:'yes-yes.mp3'},
                {text: 'Yes! Yes!', sound:'yes-yes2.mp3'},
                {text: '<Single laugh>', sound:'single-laugh.mp3'},
                {text: '<Single laugh>', sound:'single-laugh2.mp3'},
                {text: '<Applause>', sound:'applause.mp3'},
                {text: '<Applause>', sound:'applause2.mp3'},
                {text: '<Applause>', sound:'applause3.mp3'},
            ]
        },
        endings: {
            transitions: [

...
define(function(require) {
    ...
    var View = function(ending, sceneView){
        ...
        white.graphics.beginFill("#2f385a").drawRect(0, 0, game.width, game.height);
        this.addChild(white);
    ...
    View.prototype.animateIn = function(){
        TweenMax.from(this.bg, 1, {rotation:720, scaleX:0, scaleY:0, ease:'Power1.easeInOut'});
        TweenMax.from(this.newspaper, 1, {rotation:720, scaleX:0, scaleY:0, ease:'Power1.easeInOut', delay:0.5});
        TweenMax.from(this.retry, 1, {scaleX:0, scaleY:0, delay:2});
        TweenMax.from(this.quit, 1, {scaleX:0, scaleY:0, delay:2.5});
    };
